...
func TestDispatch(t *testing.T) {
	...
	pagelets[0] = &parser.Pagelet{"1", 1, "http://bj.ganji.com/ajax.php?module=suggestion&keyword=a&domain=bj"}
	pagelets[1] = &parser.Pagelet{"2", 2, "http://bj.ganji.com/ajax.php?module=suggestion&keyword=b&domain=bj"}
